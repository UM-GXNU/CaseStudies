...
//    	    System.setProperty("webdriver.chrome.driver", "E:\\soft_test\\demo\\chromedriver.exe");
            ...
            Thread.sleep(1000);
    	    //--------------------------------------------------------------
    	    driver.findElement(By.id("ProductCatalogManager")).click();
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
            //--------------------------------------------------------------
    	    driver.findElement(By.id("CashDeskManager")).click();
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
          	//--------------------------------------------------------------
          	driver.findElement(By.id("CashierManager")).click();
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
        	//--------------------------------------------------------------
          	driver.findElement(By.id("ItemManager")).click();
            Thread.sleep(1000);
            ...
            Thread.sleep(1000);
            //--------------------------------------------------------------  
            driver.findElement(By.id("SupplierManager")).click();
            Thread.sleep(1000);
