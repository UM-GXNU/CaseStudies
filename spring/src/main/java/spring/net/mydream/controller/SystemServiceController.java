...
public class SystemServiceController {
	...
	public String createUser(CreateUserMessage createUserMsg) {
		...
		try {
			object.put("data", systemService.createUser(createUserMsg.id,createUserMsg.name,createUserMsg.password,createUserMsg.phone,createUserMsg.roleCode,createUserMsg.departmentid));
	...
	public String queryUser(QueryUserMessage queryUserMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryUser(queryUserMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyUser(ModifyUserMessage modifyUserMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyUser(modifyUserMsg.id,modifyUserMsg.name,modifyUserMsg.password,modifyUserMsg.phone,modifyUserMsg.roleCode,modifyUserMsg.departmentid));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteUser(DeleteUserMessage deleteUserMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteUser(deleteUserMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createRole(CreateRoleMessage createRoleMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createRole(createRoleMsg.id,createRoleMsg.remark,createRoleMsg.roleCode));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryRole(QueryRoleMessage queryRoleMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryRole(queryRoleMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyRole(ModifyRoleMessage modifyRoleMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyRole(modifyRoleMsg.id,modifyRoleMsg.remark,modifyRoleMsg.roleCode));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteRole(DeleteRoleMessage deleteRoleMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteRole(deleteRoleMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createDepartment(CreateDepartmentMessage createDepartmentMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createDepartment(createDepartmentMsg.id,createDepartmentMsg.name,createDepartmentMsg.contactRerson,createDepartmentMsg.principal,createDepartmentMsg.phone,createDepartmentMsg.briefInfo,createDepartmentMsg.describeContent,createDepartmentMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryDepartment(QueryDepartmentMessage queryDepartmentMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryDepartment(queryDepartmentMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyDepartment(ModifyDepartmentMessage modifyDepartmentMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyDepartment(modifyDepartmentMsg.id,modifyDepartmentMsg.name,modifyDepartmentMsg.contactRerson,modifyDepartmentMsg.principal,modifyDepartmentMsg.phone,modifyDepartmentMsg.briefInfo,modifyDepartmentMsg.describeContent,modifyDepartmentMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteDepartment(DeleteDepartmentMessage deleteDepartmentMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteDepartment(deleteDepartmentMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createDeviceInfo(CreateDeviceInfoMessage createDeviceInfoMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createDeviceInfo(createDeviceInfoMsg.id,createDeviceInfoMsg.name,createDeviceInfoMsg.brand,createDeviceInfoMsg.type,createDeviceInfoMsg.address,createDeviceInfoMsg.adminName,createDeviceInfoMsg.contactsName,createDeviceInfoMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryDeviceInfo(QueryDeviceInfoMessage queryDeviceInfoMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryDeviceInfo(queryDeviceInfoMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyDeviceInfo(ModifyDeviceInfoMessage modifyDeviceInfoMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyDeviceInfo(modifyDeviceInfoMsg.id,modifyDeviceInfoMsg.name,modifyDeviceInfoMsg.brand,modifyDeviceInfoMsg.type,modifyDeviceInfoMsg.address,modifyDeviceInfoMsg.adminName,modifyDeviceInfoMsg.contactsName,modifyDeviceInfoMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteDeviceInfo(DeleteDeviceInfoMessage deleteDeviceInfoMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteDeviceInfo(deleteDeviceInfoMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createDeviceLocationGroup(CreateDeviceLocationGroupMessage createDeviceLocationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createDeviceLocationGroup(createDeviceLocationGroupMsg.id,createDeviceLocationGroupMsg.name,createDeviceLocationGroupMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryDeviceLocationGroup(QueryDeviceLocationGroupMessage queryDeviceLocationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryDeviceLocationGroup(queryDeviceLocationGroupMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyDeviceLocationGroup(ModifyDeviceLocationGroupMessage modifyDeviceLocationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyDeviceLocationGroup(modifyDeviceLocationGroupMsg.id,modifyDeviceLocationGroupMsg.name,modifyDeviceLocationGroupMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteDeviceLocationGroup(DeleteDeviceLocationGroupMessage deleteDeviceLocationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteDeviceLocationGroup(deleteDeviceLocationGroupMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createEquipmentFailureType(CreateEquipmentFailureTypeMessage createEquipmentFailureTypeMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createEquipmentFailureType(createEquipmentFailureTypeMsg.id,createEquipmentFailureTypeMsg.name,createEquipmentFailureTypeMsg.describeContent,createEquipmentFailureTypeMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryEquipmentFailureType(QueryEquipmentFailureTypeMessage queryEquipmentFailureTypeMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryEquipmentFailureType(queryEquipmentFailureTypeMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyEquipmentFailureType(ModifyEquipmentFailureTypeMessage modifyEquipmentFailureTypeMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyEquipmentFailureType(modifyEquipmentFailureTypeMsg.id,modifyEquipmentFailureTypeMsg.name,modifyEquipmentFailureTypeMsg.describeContent,modifyEquipmentFailureTypeMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteEquipmentFailureType(DeleteEquipmentFailureTypeMessage deleteEquipmentFailureTypeMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteEquipmentFailureType(deleteEquipmentFailureTypeMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createDeviceStatus(CreateDeviceStatusMessage createDeviceStatusMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createDeviceStatus(createDeviceStatusMsg.id,createDeviceStatusMsg.name,createDeviceStatusMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryDeviceStatus(QueryDeviceStatusMessage queryDeviceStatusMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryDeviceStatus(queryDeviceStatusMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyDeviceStatus(ModifyDeviceStatusMessage modifyDeviceStatusMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyDeviceStatus(modifyDeviceStatusMsg.id,modifyDeviceStatusMsg.name,modifyDeviceStatusMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteDeviceStatus(DeleteDeviceStatusMessage deleteDeviceStatusMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteDeviceStatus(deleteDeviceStatusMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String createDeviceAssociationGroup(CreateDeviceAssociationGroupMessage createDeviceAssociationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.createDeviceAssociationGroup(createDeviceAssociationGroupMsg.id,createDeviceAssociationGroupMsg.name,createDeviceAssociationGroupMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String queryDeviceAssociationGroup(QueryDeviceAssociationGroupMessage queryDeviceAssociationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.queryDeviceAssociationGroup(queryDeviceAssociationGroupMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String modifyDeviceAssociationGroup(ModifyDeviceAssociationGroupMessage modifyDeviceAssociationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.modifyDeviceAssociationGroup(modifyDeviceAssociationGroupMsg.id,modifyDeviceAssociationGroupMsg.name,modifyDeviceAssociationGroupMsg.remark));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
	...
	public String deleteDeviceAssociationGroup(DeleteDeviceAssociationGroupMessage deleteDeviceAssociationGroupMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", systemService.deleteDeviceAssociationGroup(deleteDeviceAssociationGroupMsg.id));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
